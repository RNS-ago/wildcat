...
case class WorkflowEncoderError(location: Location, msg: String) extends WorkflowCompilationError
case class CompilationError(message: String) extends WorkflowCompilationError
